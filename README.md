...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/uhdm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/uhdm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add python-uhdm uhdm
# for installing globally
pixi global install python-uhdm uhdm
```
...
It is possible to list all of the versions of `python-uhdm` available on your platform:
...
```
pixi search python-uhdm --channel conda-forge
```
